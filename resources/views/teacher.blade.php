        ...
        <div class="header-lower">
            <div class="auto-container">
                ...
                <div class="main-box">
                    ...
                    <div class="logo-box">
                        <div class="logo"><a href="index.html"><img style="margin-right: 450px;" width="250px;" src="images/FINAL V.png" alt="" title=""></a></div>
                    </div>
                    ...
                    <div class="nav-outer">
                        <nav class="nav main-menu">
                            <ul class="navigation" id="navbar">
                                ...
                                <li class="current"><a href="teacher.html">Teacher</a></li>
